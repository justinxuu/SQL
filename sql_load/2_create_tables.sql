...
ALTER TABLE public.company_dim OWNER to myuser;
ALTER TABLE public.skills_dim OWNER to myuser;
ALTER TABLE public.job_postings_fact OWNER to myuser;
ALTER TABLE public.skills_job_dim OWNER to myuser;
